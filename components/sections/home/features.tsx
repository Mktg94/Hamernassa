        ...
        >
          {features.map((feature, index) => (
            ...
            >
              ...
              {/* Hover Accent */}
              <div className="absolute top-0 right-0 w-16 h-16 bg-linear-to-br from-emerald-500/10 to-transparent rounded-bl-full opacity-0 group-hover:opacity-100 transition-opacity" />
            </motion.div>
          ))}
        </motion.div>
      </div>

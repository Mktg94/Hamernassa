...
export default function ContactPage() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section id="quote" className="relative pt-32 pb-20 bg-gradient-to-b from-brand-950 via-brand-900 to-brand-800">
              ...
              <div className="bg-white rounded-2xl p-8 border border-slate-100 shadow-soft">
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button type="submit" className="w-full py-4 bg-gradient-to-r from-brand-800 to-brand-700 text-white font-semibold rounded-xl hover:shadow-lg transition-all flex items-center justify-center gap-2">
